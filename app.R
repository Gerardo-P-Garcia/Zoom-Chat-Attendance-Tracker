...
#
# # library(rsconnect)
# # app deployed at https://gerardo-p-garcia.shinyapps.io/attendance_list/

# NEW APP (adapted from dashboard)
    ...
    ui=dashboardPage(
        ...
        dashboardSidebar(
            sidebarMenu(id="tabs",
                    ...
                    Note: the button to reveal all rows is<br/>
                    not visible for shorter lists.<br/><br/>
        ...
        dashboardBody(
            ...
            fluidRow(column(width=8, height="30vh",
                            navbarPage("Attendance",
                                       tabPanel("", DT::dataTableOutput('attendance'))
